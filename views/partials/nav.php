                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            ...
                            <a href="/unpublished" class="<?= urlIs('/unpublished') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Unpublished</a>
                            <a href="/trash" class="<?= urlIs('/trash') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Trash</a>
                        <?php endif ?>
                    </div>
                </div>
            </div>
